...
public class UpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        update_button = findViewById(R.id.dbupdate_button);
        delete_button = findViewById(R.id.dbdelete_button);

        //First we call this
        getAndSetIntentData();

        //Set the actionbar title after getAndSetIntentData method
